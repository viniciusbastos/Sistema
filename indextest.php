        ...
        *:first-child+html #menu ul a /* IE7 */
{
        ...
        <ul id="menu">
            ...
            <li onmouseover = "mudaFoto('_imagens/especificacoes.png')" onmouseout="mudaFoto('_imagens/Sem-Título-1.png')"><a href="specs.html"> Produtividade</a>
                <ul>
                    <li>
                        <a href="#">CSS</a>
                        <ul>
            ...
            <li onmouseover = "mudaFoto('_imagens/contato.png')" onmouseout="mudaFoto('_imagens/Sem-Título-1.png')"> <a href="form2_OPO.php"> OPO</a>

            <ul>
                <li id="3"><a href="index.php?link=5"> Ordem de Policiamento Ostensivo</a>
